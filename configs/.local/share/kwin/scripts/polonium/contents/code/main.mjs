  ...
  generateDrivers() {
    ...
    for (const desktop of this.ctrl.desktopFactory.createAllDesktops()) {
      ...
      if (index == -1) {
        ...
        if (this.config.autoRotateLayout && desktop.output.geometry.width < desktop.output.geometry.height) {
...
var ShortcutManager = class {
  constructor(ctrl) {
    ...
    shortcuts.getRotateLayout().activated.connect(this.rotateLayout.bind(this));
